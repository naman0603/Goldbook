...
public abstract class AppLock {
    ...
    /**
     * EXTRA_TYPE, uses to pass to the {@link package com.goldbookapp.ui.activity.AppLockActivity}
     ...
     * take into account for the {@link com.goldbookapp.inapplock.PinActivity}. These activities
     * will not log the last opened time, will not launch the
     * {@link AppLockActivityNew} etc...
     */
    ...
    /**
     * Get logo resource id used by {@link AppLockActivityNew}
     */
    public abstract int getLogoId();

    /**
     * Set logo resource id used by {@link AppLockActivityNew}
     */
    public abstract void setLogoId(int logoId);

    /**
     * Get the forgot option used by {@link AppLockActivityNew}
     */
    public abstract boolean shouldShowForgot(int appLockType);

    /**
     * Set the forgot option used by {@link AppLockActivityNew}
     */
    public abstract void setShouldShowForgot(boolean showForgot);

    /**
     * Get whether the user backed out of the {@link AppLockActivityNew} previously
     */
    public abstract boolean pinChallengeCancelled();

    /**
     * Set whether the user backed out of the {@link AppLockActivityNew}
     */
    ...
    public abstract String getPasscode(String passcode);
