...
class EditSuplierViewModel (private val apiHelper: ApiHelper) : ViewModel()  {

    var profileDetail: MutableLiveData<ProfileDetailModel> = MutableLiveData()

    fun updateSupplier( token: String?,
                     vendor_id: String?,
                     company_id: String?,
        ...
        try {
            emit(
                Resource.success(data = apiHelper.updateSupplier(token,
                    vendor_id,
                    company_id,
                    customer_type,
                    title,
