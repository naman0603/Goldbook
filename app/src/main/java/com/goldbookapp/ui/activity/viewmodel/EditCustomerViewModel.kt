...
class EditCustomerViewModel (private val apiHelper: ApiHelper) : ViewModel() {
    ...
    fun updateCustomer( token: String?,
                     customer_id: String?,
                     company_id: String?,
        ...
        emit(Resource.loading(data = null))
        try {
            emit(Resource.success(data = apiHelper.updateCustomer(token,
                customer_id,
                company_id,
                customer_type,
                title,
